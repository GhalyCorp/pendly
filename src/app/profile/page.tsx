    ...
    <>
      ...
      <main className="flex flex-col items-center relative overflow-x-hidden pb-32 w-full">
        <div className="w-full max-w-[80vw] md:max-w-[70vw] lg:max-w-[60vw] xl:max-w-[50vw] mx-auto relative">
                  <section className="flex flex-col items-center mt-24 mb-8 w-full z-10">
        ...
        <section className="w-full pb-16">
          {campaigns.length === 0 ? (
            ...
            <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-6" style={{ alignItems: 'start' }}>
